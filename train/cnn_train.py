...
def parse_args():
    # set crawler parser
    parser = argparse.ArgumentParser(description='cnn 학습 parameter 정하기')
    parser.add_argument('--batch_size', help='batch_size', default=512, type=int)
    parser.add_argument('--num_epochs', help='train epochs', default=1000, type=int)
    parser.add_argument('--hidden_dimension', help='hidden_dimension', default=500, type=int)
    parser.add_argument('--embedding_size', help='embedding size', default=300, type=int)
    parser.add_argument('--num_filters', help='num filters', default=128, type=int)
    ...
    parser.add_argument('--pre_trained_mode', help='(1) d2v (2) w2v (3) pt_w2v', default='w2v', type=str)
    parser.add_argument('--train_mode', help='(1) rand (2) static (3) non_static', default='non_static', type=str)
...
if __name__ == '__main__':
    ...
    trainable = False if args.train_mode == 'static' else True
    ...
    print(kargs)
    model_name = 'cnn_{}_{}'.format(args.train_mode, args.optimizer)
