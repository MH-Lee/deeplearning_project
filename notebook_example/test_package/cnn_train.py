...
DATA_OUT_PATH_SMALL = './model_save/cnn_model_small/'
# Data save label
...
class CNNTrain:
    def __init__(self,
        ...
        if pre_trained_mode == 'w2v':
            self.kargs['model_name'] = 'cnn_{}_{}_{}'.format(train_mode, optimizer, pre_trained_mode)
            ...
            self.kargs['model_name'] = 'cnn_{}_{}'.format(train_mode, optimizer, pre_trained_mode)

        self.kargs['trainable'] = False if train_mode == 'static' else True
        ...
        print('train_mode : {}, optimizer : {}, pre-trained_mode : {}, trainable: {}, model_name : {}'.format(
            train_mode,
            self.optimizer,
            pre_trained_mode,
            self.kargs['trainable'],
    ...
    def train(self, train_X, train_Y, lr_schedule=None):
        ...
        model = CNNClassifier(**self.kargs)
